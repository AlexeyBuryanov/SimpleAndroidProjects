...
class HSVColorPickerDialog extends AlertDialog
{
    ...
    HSVColorPickerDialog(Context context, int initialColor, final OnColorSelectedListener listener) {
        super(context);
